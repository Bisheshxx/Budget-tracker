...
- Dashboard UI: income in / expenses out / net; days-into-Period and days-until-payday context; spend-by-category breakdown; recent transactions; Budget Target shown as a **soft reference** (never pass/fail).
...
- [ ] Days-into-Period and days-until-payday are shown
