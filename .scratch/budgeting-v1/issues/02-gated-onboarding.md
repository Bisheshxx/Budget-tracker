...
- "Onboarded" is detected via `user_profiles.onboarding_completed_at IS NULL` (the signup trigger leaves it null; completing Onboarding stamps it). Display name stays optional and is not the completion signal.
...
- [ ] Completing Onboarding stamps `onboarding_completed_at` and routes to the Dashboard
