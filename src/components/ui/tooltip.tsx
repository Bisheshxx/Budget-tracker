...
// Convenience wrapper over the primitives above for the common case: hover
// `children` to show `content`. Skips wiring Tooltip/TooltipTrigger/
// TooltipContent + `asChild` by hand — reach for the primitives directly only
// when you need more than one trigger or non-default content structure.
